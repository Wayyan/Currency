...
object CommonLibs {
  ...
  const val desugar_lib = "com.android.tools:desugar_jdk_libs:1.1.5"
...
object Kotlin {
  ...
  const val stdblib_jdk = "org.jetbrains.kotlin:kotlin-stdlib:$version"
  const val gradle_plugin = "org.jetbrains.kotlin:kotlin-gradle-plugin:$version"
}

object KotlinCoroutine {
  private const val version = "1.5.1" //old 1.3.9
...
object SqlDelight {
  private const val version = "1.5.1" //old 1.4.0
  ...
  const val coroutine = "com.squareup.sqldelight:coroutines-extensions-jvm:$version"
}
...
object MDetect {
  ...
  const val mdetect = "myatminsoe.mdetect.android:mdetect-android:$version"
}
